...
The output value from map questions (`type: GeospatialField`) is an array of [geojson](https://geojson.org/) [Features](https://datatracker.ietf.org/doc/html/rfc7946#section-3.2), otherwise known as a `FeatureCollection`.
...
For example, a submission in `Prod` would look something like this: `https://forms.defra.gov.uk/submission/FZM-CFT-357/map-review/0b608f84-d2e2-4158-9737-37bd49305fd3/6b4c5b0d-7a49-459e-b9dc-db0b18cbeaa7`
