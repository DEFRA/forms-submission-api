 ...
 * @typedef {{ Params: { link: string }, Query: { preview?: FormStatus }, AuthUser: CitizenCredentials, AuthCredentialsExtra: { user: CitizenCredentials } }} GetSaveAndExitRecordRequest
 */
